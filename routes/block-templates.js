...
// PUT /api/block-templates/sort-order — Порядок элементов (Drag-and-Drop)
...
// GET /api/block-templates/:id — Один компонент с его параметрами
...
// POST /api/block-templates — Создание или обновление компонента по артикулу
...
// PUT /api/block-templates/:id — Прямое редактирование компонента
...
// DELETE /api/block-templates/:id — Удаление компонента
