...
\restrict 3hBzvUy2a8RHfdcPUbdRqt5tJH6NKgb7DbHjwj0fARWR58bXSJRaXeT2Et1y3QF
...
77	компонент шкафа	2026-07-29 08:29:47.079391	2026-07-29 08:29:47.079391	35	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	0
...
74	компонент шкафа	2026-07-29 08:14:26.777649	2026-07-29 08:14:26.777649	35	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	0
\.
...
44	Тип компонентов шкафов	\N	\N	2026-07-29 07:15:33.723875	0
\.
...
5	группа для типа компонента шкафа	\N	2	2026-07-29 08:07:18.928264
6	группа для типа компонента системы	\N	3	2026-07-29 08:18:56.259374
7	группа для компонента систем	\N	4	2026-07-29 08:23:19.999595
8	группа для шкафа	\N	5	2026-07-29 08:25:34.890129
\.
...
26	\N	материал для типа компонента системы	\N	\N	\N	\N	2026-07-29 08:18:41.459207	2026-07-29 08:18:41.459207	\N	\N	\N	\N	2
28	\N	материал для шкафа	\N	\N	\N	\N	2026-07-29 08:25:22.766609	2026-07-29 08:25:22.766609	\N	\N	\N	\N	4
25	\N	материал для компонента шкафа	\N	\N	\N	\N	2026-07-29 08:07:01.471403	2026-07-29 08:19:18.740783	\N	\N	\N	\N	1
27	\N	материал для компонента систем	\N	\N	\N	\N	2026-07-29 08:24:29.937315	2026-07-29 08:24:29.937315	\N	\N	\N	\N	3
...
14	\N	13	77	0	2026-07-29 08:29:47.088464	1	f
\.
...
29	Тип компонента систем	\N	2026-07-29 08:20:11.925698+05	2026-07-29 08:20:11.925698+05	0
\.
...
74	Компонент систем для типа компонента систем	29	\N	\N	\N	2026-07-29 08:21:53.058403+05	2026-07-29 08:21:53.058403+05	\N	\N	\N	\N	0
75	компонент систем	26	\N	\N	\N	2026-07-29 08:23:47.682925+05	2026-07-29 08:23:47.682925+05	\N	\N	\N	\N	0
\.
...
475	1	cabinet_blocks	[1, 2, 3, 4, 6, 5, 7, 8, 9, 10, -2, -7, -7, -7, -7, -7, -7, -7, -7, -7, -7, -3, -4, -4, -4, -6, -5, -1, -1, -1, "11", "12", "13", "14"]	\N	asc	{}	2026-07-29 08:29:47.150841
\.
...
SELECT pg_catalog.setval('public.block_template_material_groups_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.block_templates_id_seq', 77, true);
...
SELECT pg_catalog.setval('public.cabinet_material_groups_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.material_group_items_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.material_groups_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.materials_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.project_blocks_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.system_component_material_groups_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.system_component_type_material_groups_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.system_component_types_id_seq', 29, true);
...
SELECT pg_catalog.setval('public.system_components_id_seq', 75, true);
...
SELECT pg_catalog.setval('public.system_components_link_id_seq', 298, true);
...
SELECT pg_catalog.setval('public.user_table_sort_id_seq', 762, true);
...
\unrestrict 3hBzvUy2a8RHfdcPUbdRqt5tJH6NKgb7DbHjwj0fARWR58bXSJRaXeT2Et1y3QF
