...
\restrict hCvpjyah8M1atJogt1pdDBCJRsHErCgS0TrRZUuS0nna3hbuWA2miQt6WwQqlbR
...
31	1	\N	\N	26
28	1	\N	ИТП П3.17 ЩУВ-П2.47	21
30	1	\N	уточнить в какое помещение работает и шкаф	25
23	1	\N	Раздевалки ЩУВ-П2.47	1
27	1	\N	ИТП П3.17 ЩУВ-П2.47	20
29	1	\N	уточнить в какое помещение работает и шкаф	24
...
7	5226932	ПуГВнг(А)-LS 1х0.75 белый	\N	Провод силовой ПуГВнг(А)-LS 1х0.75белый 500м ТРТС Дмитров-Кабель	м	15.08	2026-07-01 22:59:38.992109	2026-07-07 08:46:35.375135	27	https://www.etm.ru/cat/nn/5226932	1	2
10	9888602	ПУГВнг(А)-LS 1х1.5 белый	\N	Провод силовой ПУГВнг(А)-LS 1х1.5 ТРТС белый многопроволочный 100м Дмитров-Кабель	м	27.77	2026-07-02 19:59:34.812034	2026-07-07 08:47:01.838171	27	https://www.etm.ru/cat/nn/9888602	1	1
9	8519116	Клемма двухуровневая, 2.5 кв.мм, серая	\N	Клемма двухуровневая, винтовой зажим, 4 точки подключения, 2.5 кв.мм, серая KRUKB-3 DKC	шт	374.84	2026-07-02 14:03:06.897852	2026-07-07 08:47:59.903125	4	https://www.etm.ru/cat/nn/8519116	1	2
13	7262531	ПуГВнг(А)-LS 1х0.75 синий	\N	Провод силовой ПуГВнг(А)-LS 1х0.75синий 500м ТРТ С Дмитров-Кабель	м	15.51	2026-07-04 11:12:23.024586	2026-07-07 08:46:42.791424	27	https://www.etm.ru/cat/nn/7262531	1	2
18	5044120	ПУГВнг(А)-LS 1х1.5 синий	\N	Провод силовой ПУГВнг(А)-LS 1х1.5 ТРТС синий многопроволочный Дмитров-Кабель	м	28.48	2026-07-06 10:38:46.471228	2026-07-07 08:47:11.737611	27	https://www.etm.ru/cat/nn/5044120	1	1
16	2976861	Наконечник  0.75-8	\N	Наконечник штыревой втулочный изолированный НШВИ 0.75-8 79436 КВТ	шт	0.87	2026-07-05 10:41:50.745652	2026-07-07 08:47:27.953977	28	https://www.etm.ru/cat/nn/2976861	1	2
17	2530140	Наконечник 2 х 0.75-8	\N	Наконечник штыревой втулочный изолированный НШВИ(2) 0.75-8 79462 КВТ	шт	1.64	2026-07-05 10:43:51.209397	2026-07-07 08:47:38.370945	28	https://www.etm.ru/cat/nn/2530140	1	2
\.
...
11	Датчик перепада на Фильтре	16	29	f4353453	Чистый фильтр	2026-07-02 20:17:20.770039+05	2026-07-06 22:59:32.092441+05	\N	6	2	16
3	привод заслонки притока	6	18	НС-1624331	Электропривод с возвратной пружиной LFU-230-05-MD Shuft НС-1624366	2026-06-27 12:05:35.484324+05	2026-07-07 08:50:04.01665+05	/api/system-components/3	2	4	30
...
38	привод заслонки притока	6	18	\N	Электропривод с возвратной пружиной LFU-230-05-MD Shuft НС-1624366	2026-07-07 09:30:33.660812+05	2026-07-07 09:31:13.637612+05	\N	2	4	30
...
SELECT pg_catalog.setval('public.block_templates_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.ln_values_id_seq', 70, true);
...
SELECT pg_catalog.setval('public.system_block_links_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.system_component_materials_id_seq', 173, true);
...
SELECT pg_catalog.setval('public.system_component_params_id_seq', 273, true);
...
SELECT pg_catalog.setval('public.system_component_types_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.system_components_id_seq', 44, true);
...
SELECT pg_catalog.setval('public.system_components_link_id_seq', 59, true);
...
SELECT pg_catalog.setval('public.system_modules_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.system_parameter_types_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.system_parameters_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.tm_values_id_seq', 74, true);
...
\unrestrict hCvpjyah8M1atJogt1pdDBCJRsHErCgS0TrRZUuS0nna3hbuWA2miQt6WwQqlbR
