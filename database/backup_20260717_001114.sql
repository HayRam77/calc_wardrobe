...
\restrict qByea5LVykpwA1OkmRIXxTTAUUrMXOUG0RuH3vCt09adOaaXqUZvvR2TOe8Momt
...
7	Реле 230V	2026-06-29 19:08:37.99461	2026-07-16 23:58:45.973313	29	1	SXG22P7	1003.00	\N	19.00	\N	https://systeme.ru/product/SXG22P7?ysclid=mp4113fjdn489734512	Реле 8A 2CO 230VAC тест кнопка LED	8	15
\.
...
18	5044120	ПУГВнг(А)-LS 1х1.5 синий	\N	Провод силовой ПУГВнг(А)-LS 1х1.5 ТРТС синий многопроволочный Дмитров-Кабель	м	28.48	2026-07-06 10:38:46.471228	2026-07-16 23:58:29.256377	27	https://www.etm.ru/cat/nn/5044120	1	1
10	9888602	ПУГВнг(А)-LS 1х1.5 белый	\N	Провод силовой ПУГВнг(А)-LS 1х1.5 ТРТС белый многопроволочный 100м Дмитров-Кабель	м	27.77	2026-07-02 19:59:34.812034	2026-07-16 23:58:22.75147	27	https://www.etm.ru/cat/nn/9888602	2	2
\.
...
95	\N	1	7	0	2026-07-16 23:58:45.973839	1	f
\.
...
411	68	18	1	2026-07-16 23:58:30.419156	0
412	68	17	1	2026-07-16 23:58:32.017764	0
413	68	17	1	2026-07-16 23:58:32.017809	0
414	68	17	1	2026-07-16 23:58:32.032125	0
415	68	17	1	2026-07-16 23:58:32.033323	0
\.
...
68	test	26	\N	\N	\N	2026-07-16 22:33:11.171881+05	2026-07-16 23:58:32.033323+05	\N	19	\N	\N
\.
...
SELECT pg_catalog.setval('public.ln_values_id_seq', 370, true);
...
SELECT pg_catalog.setval('public.project_blocks_id_seq', 97, true);
...
SELECT pg_catalog.setval('public.system_block_links_id_seq', 135, true);
...
SELECT pg_catalog.setval('public.system_component_materials_id_seq', 415, true);
...
SELECT pg_catalog.setval('public.system_components_link_id_seq', 155, true);
...
SELECT pg_catalog.setval('public.tm_values_id_seq', 363, true);
...
\unrestrict qByea5LVykpwA1OkmRIXxTTAUUrMXOUG0RuH3vCt09adOaaXqUZvvR2TOe8Momt
