...
29.07.2026	Сквозная интеграция Групп материалов для всех 5 типов объектов. 10-UNION калькуляция материалов. Выделение элементов с привязками жирным шрифтом (<strong>) во всех справочниках и тултипы предпросмотра.
03.08.2026	[ФИНАЛЬНАЯ СЕССИЯ] На вкладке «Группы материалов» добавлена кнопка «📋 Копировать». Скорректирован алгоритм has_bindings для Типов компонентов шкафов (проверка строго материалов и групп) и автоматический вызов перерисовки таблицы при закрытии CabinetComponentTypeModal.
