...
29.07.2026	[ФИНАЛЬНАЯ СЕССИЯ] Сквозная интеграция Групп материалов для всех 5 типов объектов. 10-UNION калькуляция материалов. Выделение элементов с привязками жирным шрифтом (<strong>) во всех справочниках и тултипы предпросмотра. Верстка привязанных объектов и кнопок действий на вкладке «Группы материалов» переведена в вертикальные столбцы.
