...
29.07.2026	[ФИНАЛЬНАЯ СЕССИЯ] Внедрено полное сквозное наследование материалов и Групп материалов для Типов компонентов шкафа (component_types). Калькуляция материалов шкафа расширена до 10 UNION. Во всех 4 справочниках реализовано выделение элементов с привязками жирным шрифтом (<strong>), а в предпросмотр тултипов при наведении добавлены Группы материалов. Внедрен модуль CabinetComponentTypeModal.
